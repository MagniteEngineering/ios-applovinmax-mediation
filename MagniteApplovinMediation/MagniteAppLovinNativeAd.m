...
@interface MagniteAppLovinNativeAd()
@property (nonatomic, strong) MGNINativeAdDetails *nativeAdDetails;
@end

@implementation MagniteAppLovinNativeAd

- (instancetype)initWithMGNINativeAdDetails:(MGNINativeAdDetails *)nativeAdDetails {
